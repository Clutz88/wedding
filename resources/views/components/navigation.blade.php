...
<nav>
        ...
        <div class="hidden w-full absolute z-50 bg-medium-green" id="navbar-hamburger">
            <ul class="flex flex-col font-medium mt-4 rounded-lg" id="mobile-nav">
                <li>
                    <a href="/" class="block py-2 px-3 {{ Request::is('/') ? 'bg-light-green' : '' }}" aria-current="page">Home</a>
                </li>
                <li>
                    <a href="/about-us" class="block py-2 px-3 {{ Request::is('about-us') ? 'bg-light-green' : '' }}">About Us</a>
                </li>
                <li>
                    <a href="/venue" class="block py-2 px-3 {{ Request::is('venue') ? 'bg-light-green' : '' }}">Venue</a>
                </li>
                <li>
                    <a href="/order-of-service" class="block py-2 px-3 {{ Request::is('order-of-service') ? 'bg-light-green' : '' }}">Order of Service</a>
                </li>
                <li>
                    <a href="{{ route('rsvp', ['rsvp' => '019559f6-a374-72c5-ae21-03abb7be7cb4']) }}" class="block py-2 px-3 {{ Request::is('rsvp') ? 'bg-light-green' : '' }}">RSVP</a>
                </li>
            </ul>
        </div>
</nav>
